...
public class AccountManagerMainXML {
    public static void main(String[] args) {
        try (var context = new ClassPathXmlApplicationContext("applicationContext.xml")) {
            ...
            accountService.transferByPhoneNumber(account1.getId(),
                    phoneNumber, 500);
            System.out.println("After transfer by phone number");
            System.out.println(account1);
            System.out.println(account2);

            accountService.transfer(account1.getId(),
                    account2.getId(), 250L);
            System.out.println("After direct transfer by phone number");
            System.out.println(account1);
            System.out.println(account2);
        }
